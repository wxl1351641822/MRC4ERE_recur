...
class GroupFeature(object):
    ...
    def __repr__(self):
        return "GroupFeature(\ndoc_tokens:{}\ntype:{},entity_type:{},relations:{}\ninput_features:{}\n)".format(self.doc_tokens,self.type,self.entity_type,self.relations,self.input_features)
...
class InputFeature(object):
    ...
    def __repr__(self):
        return "inputfeature(\ninput_ids:{}\ninput_mask:{}\nsegment_ids:{}\nlabel_id:{}\nlabel_mask:{}\nvalid_id:{})\n".format(self.input_ids,self.input_mask,self.segment_ids,self.label_id,self.label_mask,self.valid_id)
